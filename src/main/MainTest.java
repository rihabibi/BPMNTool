...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Main Index: create = "
				+ interpretor.search("create"));
		System.out
				.println("Main Index: title = " + interpretor.search("title"));
		System.out.println("Main Index: inside = "
				+ interpretor.search("inside"));
		System.out.println("Main Index: horizontal = "
				+ interpretor.search("horizontal"));
		System.out.println("Main Index: horizontal pool = "
				+ interpretor.search("horizontal pool"));
		System.out.println("Separator: called = "
				+ interpretor.isSeparator("called"));
		System.out.println("Separator: title = "
				+ interpretor.isSeparator("title"));
		System.out
				.println("Separator: too = " + interpretor.isSeparator("too"));
		System.out.println("Search: connect = "
				+ interpretor.search("connection"));
		System.out
				.println("Separator: not = " + interpretor.isSeparator("not"));
		System.out.println("Separator: number = "
				+ interpretor.isSeparator("number"));
		System.out.println("Object: start index = "
				+ interpretor.isObject("start index"));
		System.out.println("Object: horizontal = "
				+ interpretor.isObject("horizontal"));
		System.out.println("Object: pool = " + interpretor.isObject("pool"));
		System.out
				.println("Object: remove = " + interpretor.isObject("remove"));
		System.out.println("Activity: remove = "
				+ interpretor.isAction("remove"));
